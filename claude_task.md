...
**Overall Progress:** ~53% (weighted: 18/40 NH-M modules COMPLETED, 3 IN_PROGRESS, 0 UNVERIFIED, 19 NOT_STARTED — see `docs/task/status.md` ledger, reconciled 2026-07-23T10:45:00Z + NH-M09/NH-M10/NH-M12–NH-M14/NH-M16–NH-M19 work, treated as authoritative over `TODO.md`. NH-M07's COMPLETED status should be treated as unverified pending a routing sweep — see Bugs → Critical.)
...
## Company/Recruiter (NH-M19–M26) — profile/verification done, rest not started

- [x] ~~Company profile and verification~~ — done 2026-07-24, see Completed Features (M19). Team/multi-member permissions still owed (NH-M20).
...
23. Begin NH-M20 (Company Team and Permissions) — next module of the Company/Recruiter phase.
