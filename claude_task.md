...
**Overall Progress:** ~55% (weighted: 19/40 NH-M modules COMPLETED, 3 IN_PROGRESS, 0 UNVERIFIED, 18 NOT_STARTED — see `docs/task/status.md` ledger, reconciled 2026-07-23T10:45:00Z + NH-M09/NH-M10/NH-M12–NH-M14/NH-M16–NH-M20 work, treated as authoritative over `TODO.md`. NH-M07's COMPLETED status should be treated as unverified pending a routing sweep — see Bugs → Critical.)
...
## Company/Recruiter (NH-M19–M26) — profile/verification/team done, rest not started
...
24. Begin NH-M21 (Company Candidate Search) — next module of the Company/Recruiter phase.
