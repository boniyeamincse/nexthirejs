        ...
        <div className={styles.topSection}>
          <div className={styles.column}>
            ...
            <ul className={styles.nav}>
              ...
              <li>
                <Link href="/careers" className={styles.navItem}>
                  Careers
                </Link>
              </li>
              <li>
                <Link href="/press" className={styles.navItem}>
                  Press
                </Link>
              </li>
            </ul>
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.nav}>
              <li>
                <Link href="/pro" className={styles.navItem}>
                  NextHire Pro
                </Link>
              </li>
              <li>
                <Link href="/kids" className={styles.navItem}>
                  NextHire for kids
                </Link>
              </li>
              <li>
                <Link href="/business" className={styles.navItem}>
                  NextHire for business
                </Link>
              </li>
              <li>
                <Link href="/become-tutor" className={styles.navItem}>
                  Become a trainer
                </Link>
              </li>
              <li>
                <Link href="/ambassador" className={styles.navItem}>
