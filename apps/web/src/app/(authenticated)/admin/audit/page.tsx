      ...
      <div className={dashboardStyles.container}>
        <div className={dashboardStyles.hero}>
          ...
          <p className={dashboardStyles.statsText}>
            Review and search all administrative actions and system events.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className={dashboardStyles.card} style={{ textAlign: 'center', padding: '4rem 2rem' }}>
            ...
            <p style={{ color: '#94a3b8', maxWidth: '500px', margin: '0 auto', lineHeight: 1.6 }}>
              The audit logs interface is under development.
              You will soon be able to browse, filter, and export detailed logs of all administrative actions and system events for compliance and monitoring.
            </p>
          </div>
        )}
      </div>
