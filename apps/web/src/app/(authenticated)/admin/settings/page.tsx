      ...
      <div className={dashboardStyles.container}>
        <div className={dashboardStyles.hero}>
          ...
          <p className={dashboardStyles.statsText}>
            Configure global platform settings, defaults, and preferences.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className={dashboardStyles.card} style={{ textAlign: 'center', padding: '4rem 2rem' }}>
            ...
            <p style={{ color: '#94a3b8', maxWidth: '500px', margin: '0 auto', lineHeight: 1.6 }}>
              The platform settings interface is under development.
              You will soon be able to configure global application settings, default user preferences, platform limits, and integration configurations from this page.
            </p>
          </div>
        )}
      </div>
