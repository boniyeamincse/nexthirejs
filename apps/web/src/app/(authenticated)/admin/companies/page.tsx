    ...
    <div className={dashboardStyles.page}>
      ...
      <div className={dashboardStyles.container}>
        <div className={dashboardStyles.hero}>
          ...
          <h1 className={dashboardStyles.greeting}>Companies</h1>
          <p className={dashboardStyles.statsText}>
            Manage registered companies, their verifications, subscriptions, and activity.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className={dashboardStyles.card} style={{ textAlign: 'center', padding: '4rem 2rem' }}>
            ...
            <p style={{ color: '#94a3b8', maxWidth: '500px', margin: '0 auto', lineHeight: 1.6 }}>
              The full companies management interface is under development.
              You will soon be able to view, verify, and manage all registered companies, their subscription plans, and account activity from this page.
            </p>
          </div>
        )}
      </div>
