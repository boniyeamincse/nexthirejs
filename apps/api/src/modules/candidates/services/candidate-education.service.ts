...
export class CandidateEducationService {
  ...
  async listRecords(userId: string) {
    try {
      ...
      this.logger.error(
        `Error listing education records for user ${userId}`,
  ...
  async createRecord(userId: string, input: any) {
    try {
      ...
      this.logger.error(
        `Error creating education record for user ${userId}`,
        error instanceof Error ? error.stack : error,
      );
  ...
  async updateRecord(userId: string, recordId: string, input: any) {
    try {
      ...
      this.logger.error(
        `Error updating education record ${recordId} for user ${userId}`,
        error instanceof Error ? error.stack : error,
      );
  ...
  async deleteRecord(userId: string, recordId: string) {
    try {
      ...
      if (error instanceof NotFoundException) throw error;
      this.logger.error(
        `Error deleting education record ${recordId} for user ${userId}`,
        error instanceof Error ? error.stack : error,
      );
  ...
  async reorderRecords(userId: string, input: any) {
    try {
      ...
      if (error instanceof BadRequestException) throw error;
      this.logger.error(
        `Error reordering education records for user ${userId}`,
        error instanceof Error ? error.stack : error,
      );
