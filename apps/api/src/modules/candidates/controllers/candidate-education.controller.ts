...
export class CandidateEducationController {
  ...
  async createEducation(@Req() req: AuthenticatedRequest, @Body() body: any) {
  ...
  async reorderEducation(@Req() req: AuthenticatedRequest, @Body() body: any) {
  ...
  @ApiResponse({ status: 404, description: 'Education record not found' })
  async deleteEducation(@Req() req: AuthenticatedRequest, @Param('id', ParseUUIDPipe) id: string) {
