...
const FIELD_ACTION_MAP: Record<string, FieldActionConfig> = {
  ...
  countryCode: {
    section: 'LOCATION_AND_PREFERENCES',
  ...
  preferredJobRoles: {
    section: 'LOCATION_AND_PREFERENCES',
    title: 'Add preferred job roles',
    pointsAvailable: 4,
  },
  preferredWorkModes: {
    section: 'LOCATION_AND_PREFERENCES',
    title: 'Add preferred work modes',
    pointsAvailable: 2,
  },
  preferredEmploymentTypes: {
    section: 'LOCATION_AND_PREFERENCES',
    title: 'Add preferred employment types',
    pointsAvailable: 2,
  },
  education: {
    section: 'EDUCATION',
    title: 'Add at least one education record',
    pointsAvailable: 7,
  },
  educationFieldOfStudy: {
    section: 'EDUCATION',
    title: 'Add field of study to education',
    pointsAvailable: 2,
  },
  educationGradeOrDescription: {
    section: 'EDUCATION',
    title: 'Add grade or description to education',
    pointsAvailable: 2,
  },
  workExperience: {
    section: 'WORK_EXPERIENCE',
    title: 'Add at least one work experience',
    pointsAvailable: 10,
  },
  ...
  certifications: {
    ...
    title: 'Add at least one certification',
    pointsAvailable: 4,
  },
  certificationsCredential: {
    section: 'CERTIFICATIONS',
    title: 'Add credential ID or URL',
    pointsAvailable: 1,
  },
  training: { section: 'TRAINING', title: 'Add at least one training record', pointsAvailable: 3 },
  achievements: {
    section: 'ACHIEVEMENTS',
    title: 'Add at least one achievement',
    pointsAvailable: 4,
  },
  achievementsDetail: {
    section: 'ACHIEVEMENTS',
    title: 'Add details to achievement',
    pointsAvailable: 1,
  },
  professionalLinks: {
    section: 'PROFESSIONAL_LINKS',
    title: 'Add at least one professional link',
    pointsAvailable: 3,
  },
  professionalLinksKey: {
    section: 'PROFESSIONAL_LINKS',
    title: 'Add a key profile link',
    pointsAvailable: 2,
  },
};
