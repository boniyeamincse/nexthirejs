...
export const ACCOUNT_ERROR_CODES = {
  DEACTIVATION_CONFIRMATION_INVALID: 'ACCOUNT_DEACTIVATION_CONFIRMATION_INVALID',
  DEACTIVATION_RATE_LIMITED: 'ACCOUNT_DEACTIVATION_RATE_LIMITED',
  CURRENT_PASSWORD_INVALID: 'AUTH_CURRENT_PASSWORD_INVALID',
} as const;

export const DATA_EXPORT_ERROR_CODES = {
  ALREADY_ACTIVE: 'DATA_EXPORT_ALREADY_ACTIVE',
